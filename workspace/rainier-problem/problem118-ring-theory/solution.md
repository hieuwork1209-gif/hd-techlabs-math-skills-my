...
S=R[z^{-1}].
$$
The goal is to modify $E,F,H$ by elements of the localized Weyl subalgebra generated by $p,q,z^{\pm 1}$ so that the modified elements commute with both $p$ and $q$.

For $E$, write $e=E-\alpha$. Since $[E,p]=0$ and $[E,q]=p$, the conditions $[e,p]=[e,q]=0$ require
$$
[\alpha,p]=0,\qquad [\alpha,q]=p.
$$
Because $[p^2,q]=2zp$, the choice is forced by these equations:
$$
...
$$
Using $[pq,p]=-zp$ and $[pq,q]=zq$ gives
$$
...
$$
while $a,b,c$ commute with $x,y,t$ and with one another. Therefore, over
$$
K=k[z^{\pm 1}],
$$
the correspondence
...
$$
identifies these nine generators with
$$
\mathfrak l=\mathfrak{sl}_2[\varepsilon]/(\varepsilon^3).
$$
The localized Weyl pair $p,q$ commutes with $U_K(\mathfrak l)$. The usual Weyl-basis argument therefore gives
$$
