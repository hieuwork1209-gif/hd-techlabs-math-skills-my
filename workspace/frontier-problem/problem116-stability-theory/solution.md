...
$$
Thus the polynomial change of variables $(x,y)\mapsto(u,y)=(x-y^2,y)$ is a global bijection with inverse $x=u+y^2$, and in these coordinates the system is completely decoupled.
...
a+2b<5.
$$
Under these inequalities, $u(t)\to0$ and $y(t)\to0$, hence
$$
x(t)=u(t)+y(t)^2\to0.
$$
